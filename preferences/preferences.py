...
class Preferences:
    ...
    #: Temporal supersampling. TARGET samples per displayed frame -- the
    #: achieved count is the nearest one that divides physics_steps, so this is
    #: a target rather than a promise. See orchestrator.blur_schedule().
